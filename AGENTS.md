...
- Code is located in ./mcp-kubevirt/
- Install deps: `pip install --break-system-packages -r mcp-kubevirt/requirements.txt` (Alpine requires this flag)
- Run server: `uvicorn mcp-kubevirt.main:app --host 0.0.0.0 --port 8000`
...
- ARM64: `podman build --platform linux/arm64 -t quay.io/youruser/mcp-openshift:0.0.1-arm64 mcp-kubevirt/`
- AMD64: `podman build --platform linux/amd64 -t quay.io/youruser/mcp-openshift:0.0.1-amd64 mcp-kubevirt/`
...
- Server entrypoint: `uvicorn mcp-kubevirt.main:app --host 0.0.0.0 --port 8000`